...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO contact (ussrid, email, phno, message) VALUES (?, ?, ?, ?)");
    if (!$stmt) {
        die("Prepare failed: " . $conn->error);
    }
    $stmt->bind_param("isss", $ussrid, $email, $phno, $message);
...
$sql = "SELECT message, reply FROM contact WHERE ussrid = ? ORDER BY cid DESC";
