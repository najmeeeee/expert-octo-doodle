...
.error {color: red; font-size: 0.9em; margin-top: 0.5em;}
</style>
</head>
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h6>per night</h6>
    <hr>
    <form id="bookingForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      <h4>Check Availability</h4>
      <p><label><i class="fa fa-calendar-check-o"></i> Check In</label></p>
      <input id="checkin" class="w3-input w3-border" type="date" name="CheckIn" required>
      <span id="checkinError" class="error"></span>
      
      <p><label><i class="fa fa-calendar-o"></i> Check Out</label></p>
      <input id="checkout" class="w3-input w3-border" type="date" name="CheckOut" required>
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    ...
    <div class="w3-display-container mySlides">
      <img src="livingp.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Platinum Living Room</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="diningp.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Platinum Dining Room</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="bedroomp.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Platinum Bedroom</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="balconyp.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
    ...
    <div class="w3-display-container mySlides">
      <img src=""livingg.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Gold Living Room</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="diningg.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Gold Dining Room</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="bedroomg.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Gold Bedroom</p>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="balconyg.jpg" style="width:100%;margin-bottom:-6px">
      <div class="w3-display-bottomleft w3-container w3-black">
        <p>Gold Balcony</p>
      </div>
    </div>
  ...
  <div class="w3-row-padding w3-section">
    <!-- Platinum Thumbnails -->
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="livingp.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Platinum Living room">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="diningp.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(2)" title="Platinum Dining room">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="bedroomp.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(3)" title="Platinum Bedroom">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="balconyp.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(4)" title="Platinum Balcony">
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="livingg.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(5)" title="Gold Living room">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="diningg.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(6)" title="Gold Dining room">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="bedroomg.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(7)" title="Gold Bedroom">
    </div>
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="balconyg.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(8)" title="Gold Balcony">
    </div>
  </div>
...
document.getElementById('checkin').addEventListener('input', validateDates);
document.getElementById('checkout').addEventListener('input', validateDates);
...
function validateDates() {
  ...
  if (checkInDate < today) {
    ...
    checkinError.textContent = "Check-in date cannot be more than one month from today.";
  }
